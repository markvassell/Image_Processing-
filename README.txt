...
5. once you run cmake a fold that has the executable should be created in the edge directory. change to the bin directory and navigate to the executable file.  On my machine, here is how it's done (cd ../bin/macosx/)
